...
export class ColorConfig {
	...
	public static readonly defaultTheme: string = "41box";
...
:root {
    ...
    --indicator-secondary: #150c08;
    --select2-opt-group: #220a04;
    --input-box-outline: #150c08;
    --mute-button-normal: #cc7744;
    --mute-button-mod: #bb5522;

    --pitch1-secondary-channel: #aa5522;
    --pitch1-primary-channel: #bb7733;
    --pitch1-secondary-note: #aa5522;
    --pitch1-primary-note: #bb7733;
    --pitch2-secondary-channel: #994411;
    --pitch2-primary-channel: #bb6633;
    --pitch2-secondary-note: #994411;
    --pitch2-primary-note: #bb6633;
    --pitch3-secondary-channel: #883311;
    --pitch3-primary-channel: #aa5522;
    --pitch3-secondary-note: #883311;
    --pitch3-primary-note: #aa5522;
    --pitch4-secondary-channel: #772200;
    --pitch4-primary-channel: #994411;
    --pitch4-secondary-note: #772200;
    --pitch4-primary-note: #994411;
    --pitch5-secondary-channel: #994411;
    --pitch5-primary-channel: #bb6633;
    --pitch5-secondary-note: #994411;
    --pitch5-primary-note: #bb6633;
    --pitch6-secondary-channel: #883311;
    --pitch6-primary-channel: #aa5522;
    --pitch6-secondary-note: #883311;
    --pitch6-primary-note: #aa5522;
    --pitch7-secondary-channel: #994411;
    --pitch7-primary-channel: #bb6633;
    --pitch7-secondary-note: #994411;
    --pitch7-primary-note: #bb6633;
    --pitch8-secondary-channel: #772200;
    --pitch8-primary-channel: #994411;
    --pitch8-secondary-note: #772200;
    --pitch8-primary-note: #994411;
    --pitch9-secondary-channel: #883311;
    --pitch9-primary-channel: #aa5522;
    --pitch9-secondary-note: #883311;
    --pitch9-primary-note: #aa5522;
    --pitch10-secondary-channel: #994411;
    --pitch10-primary-channel: #bb6633;
    --pitch10-secondary-note: #994411;
    --pitch10-primary-note: #bb6633;

    --noise1-secondary-channel: #996633;
    --noise1-primary-channel: #bb7733;
    --noise1-secondary-note: #996633;
    --noise1-primary-note: #bb7733;
    --noise2-secondary-channel: #884422;
    --noise2-primary-channel: #bb6633;
    --noise2-secondary-note: #884422;
    --noise2-primary-note: #bb6633;
    --noise3-secondary-channel: #773311;
    --noise3-primary-channel: #aa5522;
    --noise3-secondary-note: #773311;
    --noise3-primary-note: #aa5522;
    --noise4-secondary-channel: #884422;
    --noise4-primary-channel: #bb6633;
    --noise4-secondary-note: #884422;
    --noise4-primary-note: #bb6633;
    --noise5-secondary-channel: #996633;
    --noise5-primary-channel: #bb7733;
    --noise5-secondary-note: #996633;
    --noise5-primary-note: #bb7733;

    --mod1-secondary-channel: #772200;
    --mod1-primary-channel: #bb5500;
    --mod1-secondary-note: #772200;
    --mod1-primary-note: #bb5500;
    --mod2-secondary-channel: #883311;
    --mod2-primary-channel: #bb6633;
    --mod2-secondary-note: #883311;
    --mod2-primary-note: #bb6633;
    --mod3-secondary-channel: #994411;
    --mod3-primary-channel: #bb7744;
    --mod3-secondary-note: #994411;
    --mod3-primary-note: #bb7744;
    --mod4-secondary-channel: #883311;
    --mod4-primary-channel: #bb6633;
    --mod4-secondary-note: #883311;
    --mod4-primary-note: #bb6633;

    --mod-label-primary: #150c08;
    --mod-label-secondary-text: #bb7733;
    --mod-label-primary-text: white;
    --disabled-note-primary: #555555;
    --disabled-note-secondary: #333333;
}`,
		"voxonium":
			`:root {
			--page-margin: #02070D;
